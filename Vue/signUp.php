...
<section>
    <div class="information">
                    ...
                    <div class="test2">
                        ...
                        <p>
                            ...
                            <select name="jour" id="jour"  >
                                ...
                                <option value="7" selected="selected">7</option><option value="8">8</option><option value="9">9</option>
                            ...
                            <select name="mois" id="mois"  >
                                <option value="01" selected="selected">Janvier</option><option value="02">février</option>
                            ...
                            <select name="année" id="année"  >
                                ...
                                <option value="1994" selected="selected">1994</option><option value="1995">1995</option>
        ...
        <?php if(isset($error)){ echo ' <div class="errorIncrisptionStyle"> '.$error.' </div>';} ?>
    </div>
</section>
